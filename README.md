...
**Method 1: Quick Sign In (Recommended)**
1. Go to the [live app](https://splitwise-ryuk.vercel.app/).
2. Click **"Sign in with Splitwise"** to securely authorize the app via OAuth. No manual API keys required!
